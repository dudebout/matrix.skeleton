...
\tikzset{
  ...
  style odd tiling rows/.style = {
    ...
    add styling node = {
      \foreach \row in {1, ..., \the\pgfmatrixcurrentrow}{
        \ifodd\row
          \fitandstyle{(m-tiling-row-\row)}{#1}
        \fi
      }
    }
  },
  ...
  style odd tiling rows on layer/.style 2 args= {
    ...
    add styling node = {
      \foreach \row in {1, ..., \the\pgfmatrixcurrentrow}{
        \ifodd\row
          \fitandstyle[#1]{(m-tiling-row-\row)}{#2}
        \fi
      }
    }
  },
  ...
  style odd tiling columns/.style = {
    ...
    add styling node = {
      \foreach \col in {1, ..., \the\pgf@matrix@numberofcolumns}{
        \ifodd\col
          \fitandstyle{(m-tiling-column-\col)}{#1}
        \fi
      }
    }
  },
  ...
  style odd tiling columns on layer/.style 2 args= {
    ...
    add styling node = {
      \foreach \col in {1, ..., \the\pgf@matrix@numberofcolumns}{
        \ifodd\col
          \fitandstyle[#1]{(m-tiling-column-\col)}{#2}
        \fi
      }
    }
  },
